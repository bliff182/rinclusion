...
function MenuItems() {
    return (
        <div>
            ...
            <MenuItem><a style={{ textDecoration:"none", color:"inherit"}} href="/Liked">All Previous</a></MenuItem>
            <MenuItem><a style={{ textDecoration:"none", color:"inherit"}} href="/Settings">Account</a></MenuItem>
